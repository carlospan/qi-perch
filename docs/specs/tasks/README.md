...
> 模板：`_template.md`。流程：`SDD-GUIDE.md`（**2026-08-13 起 Cursor 单线默认**；archive 内双 Agent 过程稿为史料）。  
> 回写(2026-08-07)：包 19、N5 任务包已迁入对应 archive 桶。  
> 回写(2026-08-09)：索引对齐现码——L7 N3 / 伤疤 / assist 三包工程已闭环（过程稿仍在本目录，待迁 archive）。  
> 回写(2026-08-13)：下一刀改为**世界触达四能力**（look / open / write / together）冻结；irreversible 仍未开、排在本批之后。  
> 回写(2026-08-15)：开立 open 任务包；SDD-GUIDE 增补 §2.5 渐进对齐（一块一拍）。  
> 回写(2026-08-13)：开发流程改 Cursor 单线；下列旧包文首若仍写「双 Agent」仅作史料措辞，**新包勿照抄**。
...
| [`2026-08-15-L7-write-写下-任务包.md`](2026-08-15-L7-write-写下-任务包.md) | write **工程已落地**；感受验可并行 |
| [`2026-08-15-L7-together-同看-任务包.md`](2026-08-15-L7-together-同看-任务包.md) | together **工程已落地**；感受验可并行 |
...
| [`2026-08-08-L7-curiosity候选解堵.md`](2026-08-08-L7-curiosity候选解堵.md) | **行为修复包**（史料流程：当时走双 Agent）；工程已落地，待迁 archive |

## 工程已闭环、待迁 archive（勿当未完成队列）

| 主题 | 过程稿前缀（本目录） | 现状 |
|------|----------------------|------|
| L7 explore 真搜索 C | `2026-08-08-L7-explore真搜索-*` | d-1~d-3-2 工程交付；相处复验中 |
| N3 动机接线 | `2026-08-09-L7-N3*` / 相关 | pressure 软调制 explore 已落地 |
| 伤疤失败接线 | `2026-08-09-L7-伤疤*` | `_maybe_save_scar` 骨架已落地 |
| assist | （已在 archive） | 见 `archive/2026-08-09-L7-assist/` |

## 已迁出（查 archive）

| 原 tasks 条目 | 现位置 |
|---------------|--------|
| 包 19 健康修复 | [`../archive/2026-08-04-health-fix/`](../archive/2026-08-04-health-fix/INDEX.md) |
| N5 硬闸扩展 | [`../archive/2026-08-07-n5-hard-gate/`](../archive/2026-08-07-n5-hard-gate/INDEX.md) |

阶段二/三/四与体系重构等见 [`../archive/INDEX.md`](../archive/INDEX.md)。

---

*tasks 索引 · 2026-08-15（Cursor 单线；§2.5 渐进对齐；open 包已开立待编码；irreversible 后置）*
