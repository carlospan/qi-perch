<!-- 现行路径：reference/layers/L5-relationship.md（原 layers/L5-relationship.md，2026-08-02 重构迁移；正文以代码为准，未改） -->

# L5 · 关系

> 让"你和一个 AI"变成"你和栖"。有阶段、有信任、有默契、有伤疤、有只有你们懂的东西。
>
> <!-- 演进指向(2026-08-01)：关系机制保留；阶段一将修「状态-体验脱钩」——attachment/security/trust 数值改由关系事件真实驱动（配阶段目标锚），修 attachment≈0.3 与恋人关系不符的病征。见 docs/explanation/栖·数字生命架构方案.md §2.5-5/§五。 -->
