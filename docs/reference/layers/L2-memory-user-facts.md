<!-- 现行路径：reference/layers/L2-memory-user-facts.md（原 layers/L2-memory-user-facts.md，2026-08-02 重构迁移；正文以代码为准，未改） -->
...
> <!-- 演进指向(2026-08-01)：事实层继续有效，作为「有出处的知识」并入架构方案的记忆/可塑性体系（N4），随 L2 同步演进。见 docs/explanation/栖·数字生命架构方案.md。 -->
