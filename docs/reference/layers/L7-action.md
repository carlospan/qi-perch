...
> **冻结已撤销（2026-09-07）**：旧冻结稿降为史料；其后扩能力另开任务包。见 [`specs/tasks/2026-09-07-撤销世界触达冻结.md`](../../specs/tasks/2026-09-07-撤销世界触达冻结.md)。  
...
6. **「非工具」≠ 能力天花板。** 「不是工具」约束的是**动机、姿态与留痕**（因被允许/被托付才伸手；接/拒/延；做错留疤），**不是**用「显得太能干」去阉割她能碰的世界。手可以变多；危险的是手多了却旁路成无关系的脚本壳。扩能力时**不问**「会不会太像助手」，**问**谁托的、碰谁的世界、错了留不留疤（与原则 #3、#5 同脉）。
   <!-- 回写(2026-09-07)：维护者拍板；真源 specs/tasks/2026-09-07-撤销世界触达冻结.md。 -->
...
在 assist `read_file` 旁已扩展下列能力（**不**替代 irreversible）：
...
已交付约定史料：[`specs/tasks/2026-08-13-L7-世界触达四能力-冻结.md`](../../specs/tasks/2026-08-13-L7-世界触达四能力-冻结.md)（**2026-09-07 撤销冻结**，不再作「明确不做」禁令）。  
扩能力（含多步桌面/网页操作等）另开任务包 + HITL；仍守本文设计原则。`irreversible` 未建。  
<!-- 回写(2026-09-07)：维护者撤销世界触达冻结；去掉「不做自动签到/通用网页 Agent」现行禁令措辞。 -->
