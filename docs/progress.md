...
| L6 | 具身 | 🌱 在养 | 2026-07-21 | 2026-07-21 | 黄昏的枝 + Live2D；420×680；情绪→氛围/脸色；谈=`/history`；忆=`/journal` + `journal_entry` 实时；**creation_card 谈区卡片已接**（2026-08-08）。启动：`qi-desktop` + `npm run tauri:dev`。见 `docs/how-to/换机搭建.md` §5 |
